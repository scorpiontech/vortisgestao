      ...
      <Dialog open={asaasDialogOpen} onOpenChange={setAsaasDialogOpen}>
        <DialogContent className="max-w-5xl max-h-[80vh] overflow-y-auto">
          ...
          <PeriodFilter from={asaasFrom} to={asaasTo} setFrom={setAsaasFrom} setTo={setAsaasTo}
            extra={<div className="ml-auto flex gap-2">
              <Button size="sm" onClick={printAsaas}><Printer className="h-3.5 w-3.5 mr-1.5" />Imprimir</Button>
              <Button size="sm" variant="outline" onClick={exportAsaasCSV}><Search className="h-3.5 w-3.5 mr-1.5" />Exportar CSV</Button>
            </div>}
          />
